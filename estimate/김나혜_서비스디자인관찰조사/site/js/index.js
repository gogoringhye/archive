...
products.forEach(e => {
    let prod = `
        <div class="col-3 col-md-6 col-sm-12 animate" data-animate="pulse">
            <div class="product-card animate" data-animate="pulse">
                <div class="product-card-img animate" data-animate="shakeY">
                ...
                <div class="product-card-info">
                    ...
                    <div class="product-card-name animate" data-animate="bounceIn">
                        ${e.name}
                    </div>
                    <div class="product-card-price animate" data-animate="jello">
